...
|---|---|---|---|---|
| Обработка количества задач | Результат `Выполнено: "32"; Осталось: -24`, вместо `Выполнено: 5; Осталось: 3` | Значения `"3"`, `"2"` и `"8"` были строками и склеивались | Изменить тип данных со `string` на `integer` с помощью `Number()`| Выполнено: `5`, осталось: `3` |
